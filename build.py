...
const audio=isRC?`<iframe src="https://radiocut.fm/audiocut/embed/mini/${rcSlug}/" width="100%" height="65" frameborder="0" scrolling="no" style="margin-top:.5rem;filter:invert(.85) hue-rotate(170deg);border-radius:2px"></iframe>`:(ep.mp3_url?`<audio id="${id}" controls preload="none" onplay="onAudioPlay(this)" onended="onAudioEnded(this)"><source src="${ep.mp3_url}" type="audio/mpeg"></audio>`:'');
